...
<section id="ritual-sets" class="ritual-sets-section" style="padding: clamp(3.5rem, 6vw, 5.5rem) 0; background: #ffffff; border-top: 1px solid #EBE7DF;" aria-label="<?php esc_attr_e( 'Ritual Sets & Kits You\'ll Love', 'aura-skincare' ); ?>">
