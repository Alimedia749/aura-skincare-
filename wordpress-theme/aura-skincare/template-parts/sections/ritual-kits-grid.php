...
<section id="ritual-sets" class="ritual-sets-section" style="padding: clamp(3.5rem, 6vw, 5.5rem) 0; background: #FAF7F2; border-top: 1px solid #EBE7DF;" aria-label="<?php esc_attr_e( 'New Arrivals You\'ll Love', 'aura-skincare' ); ?>">
